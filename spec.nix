{
  ...
  statusplattformNaisOperator = {
    ...
    spec = {
      ...
      replicas = {
        min = 1;
        max = 1; # TODO: Remove/increase when debugging is done
      };
      accessPolicy.outbound.rules = [{application = "portalserver";}];
    };
  };
    ...
    spec = {
      egress = [
        ...
        }
        {
          ...
          to = [
            {
              namespaceSelector.matchLabels."kubernetes.io/metadata.name" = "nais-system";
